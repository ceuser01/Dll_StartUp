...
#define SLEEP_DURATION 210000000


//offset_list
#define OFFSET_HID_NAME 3000
#define DEVICE_INSTANCES_OFFSET 20
#define OFFSET_HID_ADD 20
#define OFFSET_TRUSTMASTER_NAME 20
#define PROGRAM_OFFSET 40
#define TITLE_CLASS_OFFSET 60
#define PROGRAM_OFFSET_SECOND 80

#define OFFSET_PEDAL_NAME 100
#define OFFSET_GEARSIDE_NAME 120
//OFFSET_TRUSTMASTER_NAME


//Hwnd Define 

#define HANDLE_CREATION_DELAY_MS 150


//파서 define
#define PARSER_OFFSET 1800
#define PARSER_OFFSET_UNICODE 2000
#define PARSER_OFFSET_LOAD_DATA 3000


//MODE

#define SUSPEND_MODE 1
#define RESUME_MODE 2
